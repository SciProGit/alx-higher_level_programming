...
* **13. Linked list palindrome**
  ...
  * Test files:
    * [linked_lists.c](./tests/linked_lists.c): C functions handling linked lists for
    testing [13-is_palindrome.c](./13-is_palindrome.c) provided.
	* [13-main.c](./tests/13-main.c): Main function to test the code
